...
export const NotificationPage = ({ franchises, notifications, onMarkRead, onMarkAllRead }) => {
  ...
  return (
    <div className="relative min-h-[400px]">
      ...
      <ul
        ref={listRef}
        className="space-y-4 mb-20 max-h-[400px] overflow-y-auto" // Make list scrollable
      >
