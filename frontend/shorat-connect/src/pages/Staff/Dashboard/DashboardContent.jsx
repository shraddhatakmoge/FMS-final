...
export const DashboardContent = ({ userRole, branch }) => {
    ...
    switch (userRole) {
      ...
      case "franchise_head":
        if (branch === "branch_1") {
          ...
          return [
            { title: "Staff Members", value: 8, icon: Users, trend: { value: 1, isPositive: true }, color: "info" },
            { title: "Active Students", value: 122, icon: GraduationCap, trend: { value: 5, isPositive: true }, color: "success" },
            { title: "Monthly Revenue", value: "₹1,80,000", icon: CreditCard, trend: { value: 10, isPositive: true }, color: "warning" },
            { title: "Course Completion", value: "89%", icon: TrendingUp, trend: { value: 1, isPositive: true }, color: "success" }
          ];
        } else if (branch === "branch_3") {
          return [
            { title: "Staff Members", value: 6, icon: Users, trend: { value: 0, isPositive: true }, color: "info" },
            { title: "Active Students", value: 95, icon: GraduationCap, trend: { value: 2, isPositive: true }, color: "success" },
            { title: "Monthly Revenue", value: "₹1,20,000", icon: CreditCard, trend: { value: 8, isPositive: true }, color: "warning" },
            { title: "Course Completion", value: "85%", icon: TrendingUp, trend: { value: 2, isPositive: true }, color: "success" }
          ];
        }
        break;
      ...
      case "staff":
        if (branch === "branch_1") {
          ...
          return [
            { title: "My Students", value: 19, icon: GraduationCap, color: "success" },
            { title: "Active Batches", value: 3, icon: Users, color: "info" },
            { title: "Completion Rate", value: "91%", icon: TrendingUp, color: "success" },
            { title: "Certificates", value: 9, icon: Award, color: "primary" }
          ];
        } else if (branch === "branch_3") {
          return [
            { title: "My Students", value: 22, icon: GraduationCap, color: "success" },
            { title: "Active Batches", value: 2, icon: Users, color: "info" },
            { title: "Completion Rate", value: "88%", icon: TrendingUp, color: "success" },
            { title: "Certificates", value: 7, icon: Award, color: "primary" }
          ];
        }
        break;
  ...
  const topPerformingFranchises = [
    { name: "Wagholi Pune", students: 245, revenue: "₹4,50,000", completion: 95 },
    { name: "Ahilyanagar", students: 198, revenue: "₹3,80,000", completion: 91 },
  ];
